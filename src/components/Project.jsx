...
const lists = [
  ...
  },
  {
    ...
    desc:"An event organize web platform from where user can book parties , reception ceremony ."
  },
  {
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 col-md-offset-2 text-center heading">
              ...
              <p>
               I have worked on several projects using ReactJS , NodeJS . By developing these projects I learned new technologies ,
               build my problem solving skills .
              </p>
            </div>
          </div>
          <div className="row">
